...
const Featured = () => {
    return (
        <section style={{ backgroundImage: `url(${bg})`, backgroundSize: 'cover', backgroundPosition: 'center' }} className="bg-fixed py-12 relative lg:h-[80vh] md:h-[65vh] h-[100vh] my-16" >
            <div className="absolute w-full h-full top-0 left-0 bg-black opacity-70"></div>

            <div className="text-white z-20 absolute w-full h-full top-0 left-0">
