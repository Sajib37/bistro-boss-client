...
const SignUp = () => {
    return (
        ...
        <section className="w-full max-w-screen-xl border-2 md:px-4 mx-auto py-12 shadow-2xl flex flex-row-reverse gap-2" style={{backgroundImage: `url(${bgImage})` , backgroundSize:'cover'}}>
            ...
            <section className="max-w-md lg:w-1/2  mx-auto px-2 md:px-4  md:max-w-lg lg:max-w-lg rounded-lg py-10 md:py-12">
                ...
                <p className="font-ubuntu font-medium mt-4">Already have an account? Please, <Link className="text-Secondary " to='/signIn'>Login</Link></p>
